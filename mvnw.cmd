...
# 普通目录的 Target 在部分 PowerShell 版本中是 null，而不是空数组。
# Maven Wrapper 3.3.4 原脚本直接访问 Target[0]，会在 Windows 上触发
# "Cannot index into a null array"，导致 Wrapper 在解析 pom.xml 前就退出。
